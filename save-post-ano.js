window.history.pushState("object or string", "Post", "/post");
top.document.title='Post'
...
function anno() {
    ...
    for (var i = anon_names.length - 1; i > 0; i--) {
        ...
        var temp = anon_names[i];
        anon_names[i] = anon_names[j];
        anon_names[j] = temp;
    }
    X.QSA(document, `
                .uiProfilePhoto,
        ...
        function(i) {
            if (i.parentNode && i.parentNode.href && i.parentNode.href.indexOf("photo.php") >= 0) {
                return;
            } // photo, not profile pic
            if (i.src && i.src.indexOf("external.ak.fbcdn") >= 0) {
                return;
            } // External img
    ...
    X.QSA(document, '#navAccountName,#navTimeline a', function(o) {
        if (X(o, 'img')) {
            return;
        }
        var c = o.innerHTML;
    ...
    X.QSA(document, `
                ...
                *[data-hovercard*="user"],
                *[data-hovercard*="page"],
                *[data-hovercard*="group"],
                a[href*="/profile.php"],
                .headerTinymanName,
                .UFICommentActorName,
                .UFILikeSentence a[href^="http"],
                #navTimeline a,
                .tickerFeedMessage .passiveName,
                a.profileLink,
        ...
        function(o) {
            ...
            if (!namehash[c]) {
                ...
                namehash[c] = anon_names[namecount++ % anon_names.length];
            }
            X(o).text(namehash[c]).addClass('sfx_anonymous sfx_anonymous_' + colorhash[c]);
        });
    // Friend names in Like sentence
    X.QSA(document, 'a[href^="/ufi/reaction"] span[data-hover]', function(o) {
        X(o).safe_html(o.innerHTML.replace(/.*? and (\d+.*)$/, "$1"));
    });
    X.QSA(document, '#groupSideNav .linkWrap', function(o) {
        var c = o.innerHTML;
        if (!grouphash[c]) {
            grouphash[c] = "Group #" + (groupcount++);
        }
        X(o).text(grouphash[c]);
    });
    // Try to anonymize names in the ticker that are not friends
    X.QSA(document, '.tickerFeedMessage .fwb', function(token) {
        try {
    ...
    X.QSA(document, '.tickerFeedMessage', function(msg) {
        try {
    ...
    X.QSA(document, '#listsNav .linkWrap, #pinnedNav li[data-type="type_friend_list"] .linkWrap', function(o) {
        X(o).text('Friend List');
    });
    // Anonymize Pages
    X.QSA(document, '#pagesNav .linkWrap, #pinnedNav li[data-type="type_page"] .linkWrap', function(o) {
        X(o).text('Page');
    });
    // Anonymize Groups
    X.QSA(document, '#groupsNav .linkWrap, #pinnedNav li[data-type="type_group"] .linkWrap', function(o) {
        X(o).text('Group');
    });
    // Events
    X.QSA(document, '#pagelet_reminders #event_reminders_link .fbRemindersTitle, #eventsNav .linkWrap', function(o) {
        X(o).text('Event');
    });
    //Remove internals links
    X.QSA(document, `a[href*='www.facebook.com'], a[href^='/']`, function(msg) {
...
function save() {
    ...
    div.oajrlxb2.g5ia77u1.qu0x051f.esr5mh6w.e9989ue4.r7d6kgcz.rq0escxv.n05y2jgg.hbms080z.p7hjln8o.kvgmc6g5.cxmmr5t8.oygrvhab.hcukyx3x.jb3vyjys.rz4wbd8a.qt6c0cv9.a8nywdso.i1ao9s8h.vul9dhcy.f1sip0of.lzcic4wl.l9j0dhe7.abiwlrkh.p8dawk7l.f49446kz._3_qk.a8nywdso.qt6c0cv9.rz4wbd8a.jb3vyjys.jklb3kyz.owomucta.n3ffmt46.e9vueds3.bp9cbjyn { display: none !important; }
    ...
    h1#seo_h1_tag { display: none !important; }
    ...
    if(document.querySelector('div#contentArea')) {
        ...
        let box =  document.querySelector(".hybvsw6c.ue3kfks5.pw54ja7n.uo3d90p7.l82x9zwi.rq0escxv.ni8dbmo4.stjgntxs.l9j0dhe7.k4urcfbm.sbcfpzgs")
        let width = box.offsetWidth;
        let height = box.offsetHeight+500;
