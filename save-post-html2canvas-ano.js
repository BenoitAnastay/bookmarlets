...
function save() {
    ...
    html2canvas(document.querySelector(".userContentWrapper"),{letterRendering: 1, allowTaint : true}).then(canvas => {
        let newWin = window.open("about:blank", "capture", "width=200,height=200");
